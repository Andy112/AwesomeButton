...
public class MaterialTab implements View.OnTouchListener {
    ...
    public void setTextStyle(boolean isStyleBold) {
        if (isStyleBold) {
	...
	public MaterialTab setText(CharSequence text) {
        if(hasIcon)
            throw new RuntimeException("You had setted mad.acai.com.awesomebutton.tabs with icons, uses icons instead text");
	...
	public MaterialTab setIcon(Drawable icon) {
        if(!hasIcon)
            throw new RuntimeException("You had setted mad.acai.com.awesomebutton.tabs without icons, uses text instead icons");
